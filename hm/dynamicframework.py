...
# TODO: re-implement the below code:
...
#     def _formatMessage(self, message, prefix=""):
...
#     #     print "deprecated, update your script"
#     #     self._endTime = time.time()
#     #     self.showMessage("duration %s: %s" % (self.name, utils.duration(self._startTime, self._endTime)))
