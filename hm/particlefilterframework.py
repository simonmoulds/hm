...
class ParticleFilterModel(ParticleFilterBase):
    def __init__(self):
        ParticleFilterBase.__init__(self)

    # TODO: Implement reportState/readState methods
    def reportState(self, variable, variableName):
        ...
        # else:
        #     filename = frameworkBase.generateNameT(
        #         variableName,
...
class ParticleFilterFramework(frameworkbase.FrameworkBase):
    ...
    `userModel` Instance that models the :ref:`Particle Filter Model Concept <particleFilterModelConcept>`.
    """
    def __init__(self, userModel):
        ...
        # TODO: test if filter timesteps are in interval of model timesteps

    def _userModel(self):
        return self._d_model._userModel()

    def _userFramework(self):
        # Returns the framework provided by the user
    ...
    def _testRequirements(self):
        ...
        # TODO: test for dynamic framework model
        if not isinstance(self._userFramework(), montecarloframework.MonteCarloFramework):
    ...
    def _initialiseSampleDirectories(self):
        # Creates the subdirectories for state variables
    ...
    def _cloneData(self, samplesToClone):
        ...
        # loop through each cloned sample
